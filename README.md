This tutorial introduces two basic methods to deploy tensorflow model. Choose appropriate one to deploy your model based on how you train your model. Mode 1: build graph and use session.run; Mode 2: Estimator.  
